...
class Teste(models.Model): #Criando tabela no banco de dados # Models.model cria as tableas
    nome = models.CharField(max_length= 50) # campo
    idade = models.IntegerField() # campo

    # Ele cria o arquivo dentro do diretório Migrations
    # Executa o arquivo com um python3 manage.py makemigrations
    # depois -> python3 manage.py migrate // para aplicar as alterações
